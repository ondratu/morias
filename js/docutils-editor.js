DocutilsEditor = function(source, check_url){
    this.$source = $(source);
...
DocutilsEditor.prototype.init = function(){
    ...
    this.$btn_check = $('<a>', {type: 'button', title: 'check'})
            .addClass('btn btn-default')
            .append($('<i>')
                .addClass('fa fa-check'))
            .on('click', this.check.bind(this));
    this.btn_check_color = this.$btn_check.css('color');
    this.$btn_edit = $('<button>', {type: 'button', title: 'edit'})
            .addClass('btn btn-default active')
            .append($('<i>')
                .addClass('fa fa-edit'))
            .on('click', this.edit.bind(this));
    this.btn_edit_color = this.$btn_check.css('color');
...
DocutilsEditor.prototype.input = function(ev){
    if (this.$btn_check.css('color') == this.btn_check_color){
        this.$btn_check.css('color', 'red');
...
DocutilsEditor.prototype.check = function(ev){
    $.ajax({url: this.check_url,
            type: 'post',
            ...
            success: function (data) {
                ...
                this.$btn_check.css('color', this.btn_check_color);
            },
